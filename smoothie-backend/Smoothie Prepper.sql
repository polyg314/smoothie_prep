...
CREATE TABLE "smoothie" (
  "smoothie_id" integer PRIMARY KEY,
...
CREATE TABLE "smoothie_ingredient" (
  "smoothie_ingredient_id" integer PRIMARY KEY,
  "smoothie_id" integer,
...
CREATE TABLE "liked_smoothie" (
  "liked_smoothie_id" integer PRIMARY KEY,
  "user_id" integer,
  "smoothie_id" integer,
  "status" varchar
);
...
CREATE TABLE "saved_order" (
  "saved_order_id" integer PRIMARY KEY,
  "time_created" timestamp NOT NULL
);

CREATE TABLE "saved_order_smoothie" (
  "saved_order_smoothie_id" integer PRIMARY KEY,
